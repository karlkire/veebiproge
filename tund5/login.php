<?php
	...
	//kuni on seiise logitud pea lehele
	...
	if (empty($signupFirstNameError) and empty($signupFamilyNameError) and empty($signupBirthDayError) and empty($signupGenderError) and empty($signupEmailError) and empty($signupPasswordError)){
		...
		signUp($signupFirstName, $signupFamilyName, $signupBirthDate, $gender, $signupEmail, $signupPassword);  //globaalsed muutujad ja saadan need funcionisse 
...
<body>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		...
		<br><br>
		<input type="submit" value="Logi sisse"><span><?php echo $notice; ?></span>
	</form>
